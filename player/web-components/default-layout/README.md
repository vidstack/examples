# Player: Web Components (Default Layout)
...
[codeanywhere-link]: https://app.codeanywhere.com/#https://github.com/vidstack/examples/player/web-components/default-layout
```
